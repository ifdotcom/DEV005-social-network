...
const onGetPosts = (callback) => tf(ol(Ja(db, "posts"), dl("date", "desc")), callback);
const deletePost = (id2) => Zl(Za(db, "posts", id2));
const getPost = (id2) => Kl(Za(db, "posts", id2));
const editPost = (id2, newPost) => Yl(Za(db, "posts", id2), newPost);
const likePost = (id2, idUser2) => Yl(Za(db, "posts", id2), {
  likes: _f(idUser2)
});
const dislikePost = (id2, idUser2) => Yl(Za(db, "posts", id2), {
  likes: wf(idUser2)
});
const verifyUser = () => {
